...
export const metadata: Metadata = {
  title: 'Terms of Service — RECESS',
  description: 'RECESS terms of service for parents, guardians, and school staff.',
}
      ...
      <div className="max-w-[760px] mx-auto px-6 py-14">
        ...
        <div className="mb-10">
          ...
          <p className="text-text2 text-md leading-[1.75] mt-4">
            These terms explain what RECESS is, what you can do with it, and what we ask of you.
        ...
        <div className="space-y-10 text-text2">
          ...
          <section>
            ...
            <p className="leading-[1.75]">
              RECESS is a parent engagement platform for Ontario K–8 schools. It is designed for
          ...
          <section>
            ...
            <p className="leading-[1.75] mb-3">
              ...
              with anyone, including your child&apos;s teacher or school staff. RECESS will never ask
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-[#FEE2E2] border border-[#FCA5A5] rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm text-[#991B1B] leading-[1.65]">
                  ...
                  <li>Use RECESS for commercial or advertising purposes</li>
          ...
          <section>
            ...
            <p className="leading-[1.75]">
              ...
              RECESS reserves the right to reschedule workshops due to facilitator availability or
          ...
          <section>
            ...
            <p className="leading-[1.75]">
              RECESS provides information and communication tools to support parent engagement.
          ...
          <section>
            ...
            <p className="leading-[1.75]">
              ...
              before the changes take effect. Continued use of RECESS after that date constitutes
              acceptance of the updated terms. If you disagree with changes, you can delete your account
              at any time by emailing hello@recess.ca.
            </p>
          </section>
